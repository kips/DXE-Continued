do
	...
	local data = {
		...
		alerts = {
			...
			rainwarn = {
				varname = format(L.alerts["%s Warning"],SN[39024]),
				type = "simple", 
				text = format("%s! %s!",SN[39024],L.alerts["MOVE"]),
				time = 1.5, 
				sound = "ALERT3", 
				flashscreen = true,
				color1 = "BROWN",
			...
			silencedur = {
				varname = format(L.alerts["%s Duration"],SN[15487]),
				type = "dropdown", 
				text = format(L.alerts["%s Duration"],SN[15487]),
				time = 30, 
				flashtime = 5, 
				sound = "ALERT4", 
				color1 = "ORANGE",
