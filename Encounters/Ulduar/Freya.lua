do
	...
	local data = {
		...
		alerts = {
			spawncd = {
				varname = format(L.alerts["%s Timer"],SN[62678]),
				text = SN[62678],
				type = "dropdown",
				time = "<spawntime>",
				flashtime = 5,
			...
			giftwarn = {
				varname = format(L.alerts["%s Warning"],L.npc_ulduar["Eonar's Gift"]),
				type = "simple",
				text = format(L.alerts["%s Spawned"],L.npc_ulduar["Eonar's Gift"]).."!",
				time = 3,
				sound = "ALERT2",
				color1 = "VIOLET",
				icon = ST[62584],
			...
			attunedwarn = {
				type = "simple",
				varname = format(L.alerts["%s Removal"],SN[62519]),
				text = format(L.alerts["%s Removed"],SN[62519]).."!",
				time = 1.5,
				sound = "ALERT9",
				icon = ST[62519],
			},
			naturesfuryself = {
				varname = format(L.alerts["%s on self"],SN[62589]),
				text = format("%s: %s! %s!",L.alerts["Fury"],L.alerts["YOU"],L.alerts["MOVE NOW"]),
				type = "centerpopup",
				time = 10,
				flashtime = 10,
				color1 = "BLUE",
			...
			naturesfuryproximitywarn = {
				varname = format(L.alerts["%s Proximity Warning"],SN[62589]),
				text = format("%s: #5#! %s!",L.alerts["Fury"],L.alerts["MOVE AWAY"]),
				type = "simple",
				time = 2,
				color1 = "BLACK",
				sound = "ALERT1",
			...
			gripwarn = {
				varname = format(L.alerts["%s Warning"],SN[62532]),
				type = "simple",
				text = format("%s: %s! %s!",SN[56689],L.alerts["YOU"],L.alerts["TAKE COVER"]),
				time = 1.5,
				color1 = "GREEN",
				throttle = 5,
				sound = "ALERT6",
			...
			groundtremorwarn = {
				varname = format(L.alerts["%s Cast"],SN[62437]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[62437]),
				time = 2,
				flashtime = 2,
				color1 = "BROWN",
				color2 = "ORANGE",
			...
			groundtremorcd = {
				varname = format(L.alerts["%s Cooldown"],SN[62437]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[62437]),
				time = "<tremortime>",
				flashtime = 5,
				color1 = "TAN",
				color2 = "TAN",
			...
			unstablewarnself = {
				varname = format(L.alerts["%s on self"],SN[62217]),
				type = "simple",
				text = format("%s: %s! %s!",SN[36514],L.alerts["YOU"],L.alerts["MOVE"]),
				time = 2,
				throttle = 3,
				color1 = "YELLOW",
				sound = "ALERT3",
		...
		arrows = {
			rootarrow = {
				...
				persist = 20,
				action = "TOWARD",
				msg = L.alerts["KILL IT"],
				spell = L.alerts["Roots"],
				sound = "ALERT4",
			},
		},
		raidicons = {
