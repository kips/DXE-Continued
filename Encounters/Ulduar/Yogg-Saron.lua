do
	...
	local data = {
		...
		alerts = {
			...
			inducewarn = {
				varname = format(L.alert["%s Cast"],SN[64059]),
				type = "dropdown",
				text = format(L.alert["%s Cast"],SN[64059]),
				time = 60,
				flashtime = 5,
				color1 = "BROWN",
				color2 = "MIDGREY",
			...
			deafeningwarn = {
				varname = format(L.alert["%s Cast"],SN[64189]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[64189]),
				time = 2.3,
				color1 = "ORANGE",
				sound = "ALERT5",
				icon = ST[64189],
			...
			lunaticgazewarn = {
				varname = format(L.alert["%s Cast"],SN[64163]),
				type = "centerpopup",
