do
	...
	local data = {
		...
		alerts = {
			...
			screechwarn = {
				varname = format(L.alert["%s Cast"],SN[64386]),
				text = format(L.alert["%s Cast"],SN[64386]),
				type = "centerpopup",
				time = 2,
				color1 = "BROWN",
				sound = "ALERT1",
			...
			sentinelwarn = {
				varname = format(L.alert["%s Cast"],SN[64389]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[64389]).."!",
				time = 2,
				color1 = "BLUE",
				sound = "ALERT2",
				icon = ST[64389],
			...
			sonicscreechwarn = {
				varname = format(L.alert["%s Cast"],SN[64422]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[64422]),
				time = 2.5,
				color1 = "MAGENTA",
				color2 = "MAGENTA",
				sound = "ALERT3",
