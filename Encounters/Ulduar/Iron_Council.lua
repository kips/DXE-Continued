do
	...
	local data = {
		...
		alerts = {
			...
			fusionpunchwarn = {
				varname = format(L.alert["%s Cast"],SN[61903]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[61903]),
				time = 3,
				color1 = "BROWN",
				sound = "ALERT5",
				icon = ST[61903],
			...
			runeofsummoningwarn = {
				...
				type = "simple",
				text = format(L.alert["%s Casted"],SN[62273]).."!",
				sound = "ALERT1",
				color2 = "MAGENTA",
				time = 1.5,
				icon = ST[62273],
			...
			runeofpowerwarn = {
				varname = format(L.alert["%s Cast"],SN[61973]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[61973]),
				sound = "ALERT4",
				color1 = "GREEN",
				time = 1.5,
				icon = ST[61973],
			...
			overloadwarn = {
				varname = format(L.alert["%s Cast"],SN[61869]),
				type = "centerpopup",
			...
			whirlwarn = {
				varname = format(L.alert["%s Cast"],SN[61915]),
				type = "centerpopup",
				time = 5,
				flashtime = 5,
				text = SN[61915].."!",
