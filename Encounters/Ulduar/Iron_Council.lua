do
	...
	local data = {
		...
		alerts = {
			...
			fusionpunchwarn = {
				varname = format(L.alerts["%s Cast"],SN[61903]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[61903]),
				time = 3,
				color1 = "BROWN",
				sound = "ALERT5",
				icon = ST[61903],
			...
			fusionpunchcd = {
				varname = format(L.alerts["%s Cooldown"],SN[61903]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[61903]),
				time = 12,
				flashtime = 5,
				color1 = "BLUE",
				color2 = "GREY",
			...
			runeofsummoningwarn = {
				varname = format(L.alerts["%s Warning"],SN[62273]),
				type = "simple",
				text = format(L.alerts["%s Casted"],SN[62273]).."!",
				sound = "ALERT1",
				color2 = "MAGENTA",
				time = 1.5,
				icon = ST[62273],
			...
			runeofdeathwarn = {
				varname = format(L.alerts["%s on self"],SN[62269]),
				type = "simple",
				text = format("%s: %s!",SN[62269],L.alerts["YOU"]),
				time = 1.5,
				sound = "ALERT3",
				icon = ST[62269],
			},
			runeofpowerwarn = {
				varname = format(L.alerts["%s Cast"],SN[61973]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[61973]),
				sound = "ALERT4",
				color1 = "GREEN",
				time = 1.5,
				icon = ST[61973],
			...
			overloadwarn = {
				varname = format(L.alerts["%s Cast"],SN[61869]),
				type = "centerpopup",
				text = format("%s! %s!",SN[61869],L.alerts["MOVE AWAY"]),
				time = 6, 
				flashtime = 6,
				sound = "ALERT2",
				color1 = "PURPLE",
			...
			overloadcd = {
				varname = format(L.alerts["%s Cooldown"],SN[61869]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[61869]),
				time = 60, 
				flashtime = 5,
				sound = "ALERT9",
				color1 = "PURPLE",
			...
			tendrilsdur = {
				varname = format(L.alerts["%s Duration"],SN[61887]),
				type = "centerpopup", 
				text = format(L.alerts["%s Duration"],SN[61887]),
				time = 35, 
				color1 = "BLUE", 
				icon = ST[61887],
			},
			tendrilswarnself = {
				varname = format(L.alerts["%s on self"],SN[61887]),
				type = "simple",
				text = format("%s: %s",SN[61887],L.alerts["YOU"]).."!",
				color1 = "YELLOW",
				time = 1.5,
				flashscreen = true,
				icon = ST[61887],
			...
			tendrilswarnothers = {
				varname = format(L.alerts["%s on others"],SN[61887]),
				type = "simple",
			...
			whirlwarn = {
				varname = format(L.alerts["%s Cast"],SN[61915]),
				type = "centerpopup",
				time = 5,
				flashtime = 5,
				text = SN[61915].."!",
			...
			overwhelmdurself = {
				varname = format(L.alerts["%s on self"],L.alerts["Overwhelm"]),
				type = "centerpopup",
				text = format("%s: %s!",L.alerts["Overwhelm"],L.alerts["YOU"]),
				time = "<overwhelmtime>",
				flashtime = 25,
				color1 = "DCYAN",
				color2 = "YELLOW",
			...
			overwhelmdurothers = {
				varname = format(L.alerts["%s on others"],L.alerts["Overwhelm"]),
				type = "centerpopup",
				text = format("%s: #5#",L.alerts["Overwhelm"]),
				time = "<overwhelmtime>",
				color1 = "DCYAN",
				icon = ST[64637],
			},
