do
	...
	local data = {
		...
		userdata = {
			...
			hasbile = 0,
			tmp = "",
			crashtext = {format(L.alerts["Next %s"],SN[66683]),format(L.alerts["%s Cooldown"],SN[66683]),loop = false},
			crashtime = {36,55,loop = false},
			enragetext = {format(L.alerts["Next %s"],L.alerts["Phase"]),format(L.alerts["Next %s"],L.alerts["Phase"]),L.alerts["Enrage"], loop = false},
		},
		onstart = {
			{
				"expect",{"&difficulty&",">=","3"},
			...
			{
				"expect",{"&difficulty&","<=","2"},
				"set",{enragetext = L.alerts["Enrage"]},
			},
			{
				"alert","zerotoonecd",
		...
		alerts = {
			...
			-- Gormok
			firebombwarnself = {
				varname = format(L.alerts["%s on self"],SN[66313]),
				type = "simple",
				text = format("%s: %s! %s!",SN[66313],L.alerts["YOU"],L.alerts["MOVE"]),
				time = 2,
				throttle = 3,
				color1 = "ORANGE",
				sound = "ALERT3",
			...
			impalecd = {
				varname = format(L.alerts["%s Cooldown"],SN[66331]),
				type = "dropdown",
				text = format(L.alerts["Next %s"],SN[66331]),
				time = 10,
				flashtime = 5,
				color1 = "PURPLE",
				icon = ST[66331],
			...
			impalewarn = {
				varname = format(L.alerts["%s Warning"],SN[66331]),
				type = "simple",
				text = "<impaletext>",
				time = 3,
				icon = ST[66331],
			...
			stompwarn = {
				varname = format(L.alerts["%s Cast"],SN[66330]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[48131]),
				time = 0.5,
				color1 = "BROWN",
				sound = "ALERT5",
				icon = ST[66330],
			...
			stompcd = {
				varname = format(L.alerts["%s Cooldown"],SN[66330]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[48131]),
				time = 20.8,
				flashtime = 5,
				color1 = "TAN",
				color2 = "TAN",
			...
			-- Jormungars
			bileonself = {
				varname = format(L.alerts["%s on self"],SN[66870]),
				type = "centerpopup",
				text = format("%s: %s",SN[66870],L.alerts["YOU"]).."!",
				time = 24,
				flashtime = 24,
				sound = "ALERT3",
				color1 = "CYAN",
			...
			toxinonself = {
				varname = format(L.alerts["%s on self"],SN[66823]),
				type = "centerpopup",
				text = format("%s: %s",SN[66823],L.alerts["YOU"]).."!",
				time = 60,
				flashtime = 60,
				sound = "ALERT2",
				color1 = "GREEN",
			...
			slimepoolself = {
				varname = format(L.alerts["%s on self"],SN[67638]),
				type = "simple",
				text = format("%s: %s!",SN[67638],L.alerts["YOU"]),
				time = 3,
				sound = "ALERT1",
				color1 = "TURQUOISE",
				icon = ST[67638],
			...
			enragewarn = {
				varname = format(L.alerts["%s Warning"],SN[5229]),
				type = "simple",
			...
			moltenspewcd = {
				varname = format(L.alerts["%s Cooldown"],SN[66821]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[66821]),
				time = "<moltenspewtime>",
				color1 = "MAGENTA",
				flashtime = 5,
				icon = ST[66821],
			...
			moltenspewwarn = {
				varname = format(L.alerts["%s Cast"],SN[66821]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[66821]),
				time = 3.5,
				flashtime = 3.5,
				color1 = "MAGENTA",
				color2 = "GREY",
			...
			acidicspewcd = {
				varname = format(L.alerts["%s Cooldown"],SN[66818]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[66818]),
				time = "<acidicspewtime>",
				flashtime = 5,
				color1 = "TEAL",
				icon = ST[66818],
			...
			acidicspewwarn = {
				varname = format(L.alerts["%s Cast"],SN[66818]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[66818]),
				time = 3.5,
				flashtime = 3.5,
				color1 = "TEAL",
				color2 = "GREY",
			...
			-- Icehowl
			breathwarn = {
				varname = format(L.alerts["%s Cast"],SN[66689]),
				type = "centerpopup",
				text = SN[66689].."!",
				time = 5,
				color1 = "BLUE",
			...
			ragewarn = {
				varname = format(L.alerts["%s Warning"],SN[67657]),
				type = "centerpopup",
				text = format("%s! %s!",SN[67657],L.alerts["DISPEL"]),
				time = 15,
				throttle = 15,
				color1 = "DCYAN",
				sound = "ALERT4",
			...
			dazedur = {
				varname = format(L.alerts["%s Duration"],SN[66758]),
				type = "centerpopup",
				text = SN[66758].."!",
				time = 15,
				color1 = "GREY",
			...
			crashwarn = {
				varname = format(L.alerts["%s Cast"],SN[66683]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[66683]),
				time = 1,
				color1 = "INDIGO",
				sound = "ALERT8",
				icon = ST[66683],
			...
			crashcd = {
				varname = format(L.alerts["%s Cooldown"],SN[66683]),
				type = "dropdown",
				text = "<crashtext>",
				time = "<crashtime>",
				flashtime = 10,
			...
			tramplewarnself = {
				type = "centerpopup",
				varname = format(L.alerts["%s on self"],SN[66734]),
				text = format("%s: %s! %s",SN[66734],L.alerts["YOU"],L.alerts["MOVE"]),
				time = 4.5,
				flashtime = 4.5,
				color1 = "ORANGE",
				color2 = "GREEN",
			...
			tramplewarnothers = {
				type = "centerpopup",
				varname = format(L.alerts["%s on others"],SN[66734]),
				time = 4.5,
				text = format("%s: #5#! %s!",SN[66734],L.alerts["MOVE AWAY"]),
				color1 = "ORANGE",
				sound = "ALERT9",
				icon = ST[66734],
				flashscreen = true,
			...
			--- Phase Changes
			zerotoonecd = {
				varname = format(L.alerts["%s Timer"],L.alerts["Phase One"]),
				type = "centerpopup",
				text = format(L.alerts["%s Begins"],L.alerts["Phase One"]),
				time = 22,
				flashtime = 22,
				color1 = "MIDGREY",
				icon = ST[3648],
		...
		arrows = {
			...
			toxinarrow = {
				...
				persist = 10,
				action = "TOWARD",
				msg = L.alerts["MOVE TOWARD"],
				spell = L.alerts["Toxin"],
				sound = "ALERT3",
			},
			bilearrow = {
				varname = SN[66870],
		...
		events = { 
			...
			-- Impale - Gormok application
			{
				...
				execute = {
					{
						"expect",{"#4#","==","&playerguid&"},
						"set",{impaletext = format("%s: %s!",SN[66331],L.alerts["YOU"])},
						"alert","impalewarn",
					},
					{
						"expect",{"#4#","~=","&playerguid&"},
			...
			-- Impale Stacks - Gormok
			{
				...
				execute = {
					{
						"expect",{"#4#","==","&playerguid&"},
						"set",{impaletext = format("%s: %s! %s!",SN[66331],L.alerts["YOU"],format(L.alerts["%s Stacks"],"#11#"))},
						"alert","impalewarn",
					},
					{
						"expect",{"#4#","~=","&playerguid&"},
						"set",{impaletext = format("%s: #5#! %s!",SN[66331],format(L.alerts["%s Stacks"],"#11#")) },
						"alert","impalewarn",
					},
				},
			},
