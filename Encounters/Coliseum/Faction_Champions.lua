do
	...
	local data = {
		...
		alerts = {
			bloodlustwarn = {
				varname = format(L.alerts["%s Warning"],SN[65980]),
				type = "simple",
				text = format(L.alerts["%s Casted"],SN[65980]).."! "..L.alerts["DISPEL"].."!",
				time = 3,
				sound = "ALERT1",
				color1 = "ORANGE",
				icon = ST[65980],
			...
			heroismwarn = {
				varname = format(L.alerts["%s Warning"],SN[65983]),
				type = "simple",
				text = format(L.alerts["%s Casted"],SN[65983]).."! "..L.alerts["DISPEL"].."!",
				time = 3,
				sound = "ALERT1",
				color1 = "ORANGE",
				icon = ST[65983],
			...
			divineshielddur = {
				varname = format(L.alerts["%s Duration"],SN[66010]),
				type = "centerpopup",
			...
			avengwrathdur = {
				varname = format(L.alerts["%s Duration"],SN[66011]),
				type = "centerpopup",
			...
			hellfirewarn = {
				varname = format(L.alerts["%s Cast"],SN[68145]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[68145]).."!",
				time = 15,
				flashtime = 15,
				color1 = "BROWN",
				color2 = "PEACH",
			...
			hellfireself = {
				varname = format(L.alerts["%s on self"],SN[68145]),
				type = "simple",
				text = format("%s: %s! %s!",SN[68145],L.alerts["YOU"],L.alerts["MOVE AWAY"]),
				time = 3,
				throttle = 3,
				sound = "ALERT3",
				icon = ST[68145],
			...
			hopdur = {
				varname = format(L.alerts["%s Duration"],SN[66009]),
				type = "centerpopup",
			...
			hofdur = {
				varname = format(L.alerts["%s Duration"],SN[66115]),
				type = "centerpopup",
			...
			bladestormdur = {
				varname = format(L.alerts["%s Duration"],SN[65947]),
				type = "centerpopup",
			...
			bladestormself = {
				varname = format(L.alerts["%s on self"],SN[65947]),
				type = "simple",
				text = format("%s: %s! %s!",SN[65947],L.alerts["YOU"],L.alerts["MOVE AWAY"]),
				time = 3,
				throttle = 3,
				icon = ST[65947],
				sound = "ALERT3",
			...
			retaldur = {
				varname = format(L.alerts["%s Duration"],SN[65932]),
				type = "centerpopup",
			...
			retalself = {
				varname = format(L.alerts["%s on self"],SN[65934]),
				type = "simple",
				text = format("%s: %s!",SN[65934],L.alerts["YOU"]),
				time = 3,
				throttle = 3,
				sound = "ALERT3",
				icon = ST[65934],
			...
			counterspellcd = {
				varname = format(L.alerts["%s Cooldown"],SN[65790]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[65790]),
				time = 24,
				flashtime = 5,
				color1 = "VIOLET",
				icon = ST[65790],
			...
			spelllockcd = {
				varname = format(L.alerts["%s Cooldown"],SN[67519]),
				type = "dropdown",
				text = format(L.alerts["%s Cooldown"],SN[67519]),
				time = 24,
				flashtime = 5,
				color1 = "TAN",
				icon = ST[67519],
