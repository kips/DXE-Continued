	...
	local data = {
		...
		alerts = {
			...
			pursueself = {
				...
				time = 60,
				flashtime = 60,
				text = format("%s: %s! %s!",SN[62374],L.alerts["YOU"],L.alerts["RUN"]),
				sound = "ALERT1",
				color1 = "BROWN",
				color2 = "GREY",
				icon = ST[67574],
			...
			burrowcd = {
				varname = format(L.alerts["%s Cooldown"],SN[26381]),
				type = "dropdown",
				text = format(L.alerts["Next %s"],SN[26381]),
				time = "<burrowtime>",
				flashtime = 10,
				color1 = "ORANGE",
				icon = ST[1784],
			...
			burrowdur = {
				varname = format(L.alerts["%s Duration"],SN[26381]),
				type = "centerpopup",
				text = format(L.alerts["%s Duration"],SN[26381]),
				time = 64,
				flashtime = 10,
				color1 = "GREEN",
				icon = ST[56504],
			...
			shadowstrikewarn = { 
				varname = format(L.alerts["%s Cast"],SN[66134]),
				type = "centerpopup", 
				text = format(L.alerts["%s Cast"],SN[66134]),
				time = 8, 
				flashtime = 8,
				color1 = "PURPLE", 
				sound = "ALERT5",
			...
			shadowstrikecd = {
				varname = format(L.alerts["%s Cooldown"],SN[66134]),
				type = "dropdown", 
				text = format(L.alerts["%s Cooldown"],SN[66134]),
				time = "<striketime>",
				flashtime = 10,
				color1 = "VIOLET",
				icon = ST[66135],
			...
			leechingswarmwarn = {
				varname = format(L.alerts["%s Cast"],SN[66118]),
				type = "centerpopup",
				text = format(L.alerts["%s Cast"],SN[66118]),
				time = 1.5,
				flashtime = 1.5,
				color1 = "DCYAN",
				sound = "ALERT7",
			...
			nerubiancd = {
				varname = format(L.alerts["%s Timer"],SN[66333]),
				type = "dropdown",
				text = format(L.alerts["%s Spawns"],SN[66333]),
				time = "<nerubiantime>",
				flashtime = 10,
				color1 = "INDIGO",
				icon = ST[66333],
			...
			slashwarn = {
				varname = format(L.alerts["%s on others"],SN[66012]),
				type = "centerpopup",
				time = 3,
				flashtime = 3,
			...
			slashcd = {
				varname = format(L.alerts["%s Cooldown"],SN[66012]),
				type = "dropdown",
				time = 20,
				flashtime = 5,
				text = format(L.alerts["%s Cooldown"],SN[66012]),
				color1 = "YELLOW",
				icon = ST[66012],
			},
			coldcd = {
				varname = format(L.alerts["%s Cooldown"],SN[68509]),
				type = "dropdown",
				time = 16,
				flashtime = 5,
				text = format(L.alerts["%s Cooldown"],SN[68509]),
				color1 = "TURQUOISE",
				icon = ST[68509],
			},
			coldselfwarn = {
				varname = format(L.alerts["%s on self"],SN[68509]),
				type = "simple",
				time = 3,
				text = format("%s: %s!",SN[68509],L.alerts["YOU"]),
				flashscreen = true,
				sound = "ALERT9",
				icon = ST[68509],
			},
			colddur = {
				varname = format(L.alerts["%s Duration"],SN[68509]),
				type = "centerpopup",
				time = 18,
				flashtime = 18,
				text = format(L.alerts["%s Duration"],SN[68509]),
				color1 = "MAGENTA",
				sound = "ALERT2",
				icon = ST[68509],
			},
