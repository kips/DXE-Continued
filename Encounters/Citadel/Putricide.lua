do
	...
	local data = {
		...
		userdata = {
			oozeaggrotext = {format(L.alert["%s Aggros"],L.npc_citadel["Volatile Ooze"]),format(L.alert["%s Aggros"],L.npc_citadel["Gas Cloud"]),loop = true},
			bloattext = "",
			experimenttime = 25,
			malleabletime = 6,
			gasbombtime = 16,
		...
		alerts = {
			...
			unstableexperimentwarn = {
				varname = format(L.alert["%s Cast"],SN[71966]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[71966]),
				sound = "ALERT1",
				color1 = "MAGENTA",
				time = 2.5,
				flashtime = 2.5,
			...
			oozeadhesivecastwarn = {
				varname = format(L.alert["%s Cast"],SN[72836]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[72836]),
				time = 3,
				color1 = "DCYAN",
				icon = ST[72836],
			},
			...
			bloatcastwarn = {
				varname = format(L.alert["%s Cast"],SN[72455]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[72455]),
				time = 3,
				color1 = "BROWN",
				icon = ST[72455],
			},
			...
			malleablegoowarn = {
				...
				type = "simple",
				text = format(L.alert["%s Casted"],SN[72615]),
				time = 3,
				sound = "ALERT6",
				color1 = "BLACK",
				icon = ST[72615],
			...
			teargaswarn = {
				varname = format(L.alert["%s Cast"],SN[71617]),
				type = "centerpopup",
				text = format(L.alert["%s Cast"],SN[71617]),
				time = 2.5,
				sound = "ALERT7",
				color1 = "INDIGO",
				icon = ST[71617],
